...
/* Picasa API Model
 *
 * Model for using the Picasa video albums
...
(function (exports) {
    ...
    function PicasaAPIModel(appSettings) {
            ...
            utils.ajaxWithRetry({
                ...
                success: function (jsonData) {
                    jsonData.sort(function compare(a, b) {
                        ...
                        if (x.num_photos > 0) {
                            this.albumData.push(x);
                            this.categoryData.push(x.title);
                        }
                    });
                    dataLoadedCallback();
                }.bind(this),
        ...
        this.getCategoryData = function (categoryCallback) {
            var albumId = this.albumData[this.currentCategory].id;
            utils.ajaxWithRetry({
                url: "/index/album/" + albumId,
                type: 'GET',
                dataType: 'json',
                context: this,
                cache: true,
                ...
                success: function (jsonData) {
                    ...
                    this.currData = contents.sort(function compare(a, b) {
                        if (a.title < b.title)
                            return -1;
                        if (a.title > b.title)
                            return 1;
    ...
    exports.PicasaAPIModel = PicasaAPIModel;
